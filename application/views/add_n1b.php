                  ...
                  <div class="mws-panel-body no-padding">
                    ...
                    <table class="mws-table">
                      <thead>
                        ...
                        <form class="mws-form" action="<?php echo base_url(); ?>index.php/main/add_n1_proses/" method="post" name="myForm" onSubmit="return validateForm()" enctype="multipart/form-data">
                        <?php }else{ ?>
              <form class="mws-form" action="<?php echo base_url(); ?>index.php/main/edit_upload_n1_proses/" method="post" name="myForm" onSubmit="return validateForm()" enctype="multipart/form-data">
                        <?php } ?>
                      ...
                      <tbody>
                        <tr>
                          ...
                          <td>  <div class="mws-form-item">
                                	 <textarea rows="" id="n1"  cols=""  name="n1" style="width: 500px; height: 200px;"  ><?php if(!empty($n1)){echo $n1;}?></textarea>
                                </div>
                  ...
                  <form class="mws-form" action="<?php echo base_url(); ?>index.php/main/add_markah_n16_proses/" method="post" name="myForm" onSubmit="return validateForm()" >       
                        ...
                        <?php if($level=='4'){  ?>    
                          ...
                          <td><div class="mws-form-col-3-8">
                                ...
                                <div class="mws-form-item">
                                  <input type="number" name="markah_n1" value="<?php if(!empty($markah_n1)){echo $markah_n1;}?>" min="0" max="10">
                                /10</div>
                              </div>  </td> 
                ...
                <div class="mws-panel grid_8">
                  ...
                  <div class="mws-panel-body no-padding">
                    <table width="141" class="mws-table">
                      <thead>
                        
                          
                          <th width="79">KRITERIA</th>
                          <th width="50">Huraian</th>
                        ...
                        <tr>
                          ...
                          <td>
                            	<ul class="thumbnails mws-gallery">
                                   <li>
                                   <span class="thumbnail"><img src="<?php echo base_url();?>upload/<?php echo $image1_n1; ?>" alt=""></span>
                                   <span class="mws-gallery-overlay">
          <a href="<?php echo base_url();?>upload/<?php echo $image1_n1; ?>" rel="prettyPhoto[gallery1]" class="mws-gallery-btn"><i class="icon-search"></i></a></td>
                        ...
                        <tr>
                          ...
                          <td>
                          	...
                          	<ul class="thumbnails mws-gallery">
                                   <li>
                                   <span class="thumbnail"><img src="<?php echo base_url();?>upload/<?php echo $image2_n1; ?>" alt=""></span>
                                   <span class="mws-gallery-overlay">
             <a href="<?php echo base_url();?>upload/<?php echo $image2_n1; ?>" rel="prettyPhoto[gallery1]" class="mws-gallery-btn"><i class="icon-search"></i></a>
                                </span>    
                                </td>
