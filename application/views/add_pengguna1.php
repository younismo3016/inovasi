							...
							?>
                	            <tr>
                	              ...
                	              <td class="actions" ><center>
                	                <!--<span class="btn-group"> <a href="<?php echo base_url();?>index.php/main/view_projek/<?php echo $row->id_projek; ?>" class="btn btn-small" title="papar"><i class="icon-search"></i>--></a> <a href="<?php echo base_url();?>index.php/main/edit_daftar_projek/<?php echo $row->id_projek; ?>" class="btn btn-small" title="kemaskini"><i class="icon-pencil"></i></a>  </span></td>
                	              <td class="actions" ><center>
                	                <a href="<?php echo base_url();?>index.php/main/view_projek/<?php echo $row->id_projek; ?>"> Pengesahan</a></td>
              	              </tr>
                	            <?php } ?>
              	            </tbody>
              	          </table>
