 ...
 <!-- Start: HEADER -->
  <header>
	<table width="100%" border="0" cellspacing="0" cellpadding="0">
		<tr>
			<td width="50%" td align="center"><img src ="<?php echo base_url();?>assets/images/core/bg/esurat_banner3c.jpg" style="position:absolute; top:0px; left:0px; width:100%; max-height:100%; border:0;">		
		</tr>
	</table>
            ...
            <div id="mws-login-form">
                <form class="mws-form" action="<?php echo base_url();?>index.php/login/login_proses" method="post">
                    <div class="mws-form-row">
                        <div class="mws-form-item">
                            <input type="text" name="email" name="email" placeholder="E-mel" class="mws-login-username required">
                        </div>
                    </div>
                    <div class="mws-form-row">
                        <div class="mws-form-item">
                ...
                <div class="mws-form-row">
                    ...
                    <div class="mws-form-row">
                         ...
                         <a href="<?php echo base_url();?>assets/images/core/bg/ManualPenggunaHabInovasi.zip"> Manual Pengguna</a>
                    </div>
            </div>
        </div>
    </div>
	...
	<table width="100%" border="0" cellspacing="0" cellpadding="0">
		<tr>
			<td width="100%" td align="center"><h2>Sistem Inovasi dalam proses penaiktarafan ke platform yang baru</h2>  		
		</tr>
	</table>
            <div align="center"></div>
	</header>
