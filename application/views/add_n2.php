                  ...
                  <div class="mws-panel-body no-padding">
                    ...
                    <table class="mws-table">
                      <thead>
                        ...
                        <form class="mws-form" action="<?php echo base_url(); ?>index.php/main/add_n2_proses/" method="post" name="myForm" onSubmit="return validateForm()">
                        <?php }else{ ?>
              <form class="mws-form" action="<?php echo base_url(); ?>index.php/main/edit_n2_proses/" method="post" name="myForm" onSubmit="return validateForm()" >
                        <?php } ?>
                      ...
                      <tbody>
                        <tr>
                          ...
                          <td><p>KEDUDUKAN SEBELUM INOVASI </p></td>
                          <td>  <div class="mws-form-item">
                                	 <textarea rows="" id=""  cols=""  name="n2" style="width: 500px; height: 200px;"  ><?php if(!empty($n2)){echo $n2;}?></textarea>
                                </div>
                                
                                </td>
                          
                          <td> <?php if($level == "5" || $level == "4"  ){ ?>
                  ...
                  <form class="mws-form" action="<?php echo base_url(); ?>index.php/main/edit_markah_n2_proses/" method="post" name="myForm" onSubmit="return validateForm()" >
                           <?php }else{  ?>
                  <form class="mws-form" action="<?php echo base_url(); ?>index.php/main/add_markah_n2_proses/" method="post" name="myForm" onSubmit="return validateForm()" >       
                        ...
                        <?php if($level=='4'){  ?>    
                          ...
                          <td><div class="mws-form-col-3-8">
                                ...
                                <div class="mws-form-item">
                                  <input type="text" name="markah_n2" value="<?php if(!empty($markah_n2)){echo $markah_n2;}?>">
                                </div>
                              </div>  </td> 
                          ...
                          <div class="mws-button-row">
                               <button type="submit" class="btn btn-primary" id="validateButton" name="validateButton">Kemaskini Markah</button>
                                <input  name="id_projek" id="id_projek" type="hidden" value="<?php echo $id_projek; ?>"><?php echo $id_markah_inovasi; ?>
                  ...
                  <div class="mws-panel-body no-padding">
                    <table width="307" class="mws-table">
                      ...
                      <?php if($act == "add"){ ?>
                        ...
                        <form class="mws-form" action="<?php echo base_url(); ?>index.php/main/add_n2_proses/" method="post" name="myForm" onSubmit="return validateForm()" enctype="multipart/form-data">
                        <?php }else{ ?>
              <form class="mws-form" action="<?php echo base_url(); ?>index.php/main/edit_upload_n2_proses/" method="post" name="myForm" onSubmit="return validateForm()" enctype="multipart/form-data">
                        <?php } ?>
          	 ...
          	 <a href="<?php echo base_url();?>uploads/<?php echo $image1_n2; ?>" target="_blank" class="mws-gallery-btn"><?php if(!empty($image1_n2)){echo $image1_n2;}?></a>
