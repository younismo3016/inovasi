        ...
        <div id="mws-container" class="clearfix">
            ...
            <div class="container">
                ...
                <div class="mws-panel grid_8">
                  <div class="mws-panel-header"> <span><i class="icon-table"></i> Simple Table</span> </div>
                  <div class="mws-panel-body no-padding">
                    <table class="mws-table">
                      <thead>
                        ...
                        <form class="mws-form" action="<?php echo base_url(); ?>index.php/main/add_n15_proses/" method="post" name="myForm" onSubmit="return validateForm()">
                        <?php }else{ ?>
              <form class="mws-form" action="<?php echo base_url(); ?>index.php/main/edit_n15_proses/" method="post" name="myForm" onSubmit="return validateForm()">
                        <?php } ?>
                      ...
                      <tbody>
                        ...
                        <textarea rows=""  cols=""  name="n15" style="width: 500px; height: 200px;"  ><?php if(!empty($n15)){echo $n15;}?></textarea>
                                </div>
