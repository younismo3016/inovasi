                  ...
                  <div class="mws-panel-body no-padding">
                    <table class="mws-table">
                      <thead>
                        ...
                        <form class="mws-form" action="<?php echo base_url(); ?>index.php/main/add_n13_proses/" method="post" name="myForm" onSubmit="return validateForm()">
                        <?php }else{ ?>
              <form class="mws-form" action="<?php echo base_url(); ?>index.php/main/edit_n13_proses/" method="post" name="myForm" onSubmit="return validateForm()">
                        <?php } ?>
                      ...
                      <tbody>
                        ...
                        <textarea rows=""  cols=""  name="n13" style="width: 500px; height: 200px;"  ><?php if(!empty($n13)){echo $n13;}?></textarea>
                                </div>
