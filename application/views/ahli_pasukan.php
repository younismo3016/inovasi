    ...
    <div id="mws-wrapper">
        ...
        <div id="mws-container" class="clearfix">
            ...
            <div class="container">
                ...
                <div class="mws-panel grid_8">
                	<div class="mws-panel-header"><span><i class="icon-tags"></i>Tambah Ahli Pasukan Projek : <?php echo $tajuk_projek; ?></span></div>
                    <div class="mws-panel-body no-padding">
                    	<form class="mws-form" form id="mws-validate" action="<?php echo base_url();?>index.php/main/ahli_pasukan_proses" method="post">
                          ...
                          <div class="mws-form-row">
                    		  <div class="mws-form-cols">
                    		    <div class="mws-form-col-4-8">
                    		      ...
                    		      <div class="mws-form-item">
                    		        <input type="text" name="jawatan"  value="" class="required">
                  		        </div>
                  		      </div>
                    		    <div class="mws-form-col-3-8">
                    		      <label class="mws-form-label">No Telefon Bimbit<span class="required">*</span></label>
                    		      <div class="mws-form-item">
                    		        <input type="text" name="no_tel_bimbit"  value="" class="required">
                  		        </div>
                  		      </div>
                  		    </div>
                  		  </div>
                           ...
                           <div class="mws-form-row">
                    		  <div class="mws-form-cols">
                    		    <div class="mws-form-col-4-8">
                    		      ...
                    		      <div class="mws-form-item">
                    		        <input type="text" name="gred"  value="" class="required">
                  		        </div>
                  		      </div>
                    		    <div class="mws-form-col-3-8">
                    		      <label class="mws-form-label">E-mail<span class="required">*</span></label>
                    		      <div class="mws-form-item">
                    		        <input type="text" name="email"  value="" class="required email large">
                  		        </div>
                  		      </div>
                  		    </div>
                  		  </div>
						...
						<div class="mws-button-row">
										...
										<input type="submit" value="Tambah Ahli Pasukan" name="Simpan" class="btn btn-success">
                                        <input type="hidden"  name="key" value="<?php echo $this->session->userdata('sess_id'); ?>" >
	 ...
	 <!-- ########################################### End Panel carian ################################################ -->
            	...
            	<div class="mws-panel grid_8">
                    ...
                    <form class="mws-form" action="<?php echo base_url();?>index.php/main/del_ahli_pasukan" method="post">
                    <div class="mws-panel-body no-padding">
                        <table class="mws-datatable-fn mws-table">
                            <thead>
                                <tr>
                                    ...
                                    <th width="45">No Telefon</th>
                                    <th width="59">Tindakan</th>
							...
							?>
                                ...
                                <tr>
									...
									<span class="btn-group">
                                            ...
                                            <a href="<?php echo base_url();?>index.php/main/del_ahli_pasukan/<?php echo $row->id_ahli_pasukan; ?>/<?php echo $id_projek; ?>" class="btn btn-small" onclick="return confirm('Anda pasti untuk padam')"><i class="icon-trash"></i> <input type="hidden"  name="id_projek" value="<?php echo $id_projek; ?>"  ></a>
                                        </span>
									</form>
									</td>
                                </tr>
