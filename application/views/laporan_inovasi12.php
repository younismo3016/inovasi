...
<body>
    ...
    <div id="mws-wrapper">
        ...
        <div id="mws-container" class="clearfix">
                     ...
                     <div class="mws-panel-toolbar">
                        <div class="btn-toolbar">
                            <div class="btn-group dropup">
                             <?php if(!empty($n1))
                          {?>
                    <a href=" <?php echo base_url();?>index.php/main/senarai_projek/<?php echo $id_projek; ?>" class="btn"><i class="icol-cross"></i> Senarai Laporan</a>
                    ...
                    <div class="mws-panel-body no-padding">
                      ...
                      <thead>
                        <tr>
                          ...
                          <th width="157">TUJUAN INOVASI </th>
                        </tr>
                      </thead>
                      <tbody>
                        <tr>
         ...
         <td> <textarea rows="" cols="" name="n1"  style="width: 667px; height: 200px;" value="" ><?php if(!empty($n1)){echo $n1;}?></textarea></td>
                      ...
                      <thead>
                        <tr>
                          ...
                          <th width="157">KEDUDUKAN SEBELUM INOVASI&#13;</th>
                        </tr>
                      </thead>
                      <tbody>
                        <tr>
         ...
         <td><textarea rows="" cols="" name="n9"  style="width: 667px; height: 200px;" value="" ><?php if(!empty($n1)){echo $n1;}?>
         </textarea></td>
                      ...
                      <thead>
                        <tr>
                          ...
                          <th width="157">MASALAH YANG DIHADAPI&#13;</th>
                        </tr>
                      </thead>
                      <tbody>
                        <tr>
         ...
         <td><textarea rows="" cols="" name="n10"  style="width: 667px; height: 200px;" value="" ><?php if(!empty($n1)){echo $n1;}?>
         </textarea></td>
                      ...
                      <thead>
                        <tr>
                          ...
                          <th width="157">INOVASI YANG DILAKSANAKAN&#13;</th>
                        </tr>
                      </thead>
                      <tbody>
                        <tr>
         ...
         <td><textarea rows="" cols="" name="n11"  style="width: 667px; height: 200px;" value="" ><?php if(!empty($n1)){echo $n1;}?>
         </textarea></td>
         ...
         <td><textarea rows="" cols="" name="n12"  style="width: 667px; height: 200px;" value="" ><?php if(!empty($n1)){echo $n1;}?>
         </textarea></td>
                      ...
                      <thead>
                        <tr>
                          ...
                          <th width="157">EFISIENSI – PENJIMATAN MASA </th>
                        </tr>
                      </thead>
                      <tbody>
                        <tr>
         ...
         <td><textarea rows="" cols="" name="n13"  style="width: 667px; height: 200px;" value="" ><?php if(!empty($n1)){echo $n1;}?>
         </textarea></td>
                  ...
                  <div class="mws-panel-body no-padding">
                      ...
                      <thead>
                        <tr>
                          ...
                          <th width="157">EFISIENSI – PENJIMATAN KOS&#13;</th>
                        </tr>
                      </thead>
                      <tbody>
                        <tr>
         ...
         <td> <textarea rows="" cols="" name="n1"  style="width: 667px; height: 400px;" value="" ><?php if(!empty($n1)){echo $n1;}?></textarea></td>
                      ...
                      <thead>
                        <tr>
                          ...
                          <th width="157">EFISIENSI – PENINGKATAN PRODUKTIVITI&#13;</th>
                        </tr>
                      </thead>
                      <tbody>
                        <tr>
         ...
         <td><textarea rows="" cols="" name="n2"  style="width: 667px; height: 400px;" value="" ><?php if(!empty($n1)){echo $n1;}?>
         </textarea></td>
                      ...
                      <thead>
                        <tr>
                          ...
                          <th width="157">EFISIENSI –MUDAH DIGUNAKAN (USER FRIENDLY)</th>
                        </tr>
                      </thead>
                      <tbody>
                        <tr>
         ...
         <td><textarea rows="" cols="" name="n3"  style="width: 667px; height: 400px;" value="" ><?php if(!empty($n1)){echo $n1;}?>
         </textarea></td>
                      ...
                      <thead>
                        <tr>
                          ...
                          <th width="157">EFISIENSI – LAIN-LAIN FAEDAH&#13;</th>
                        </tr>
                      </thead>
                      <tbody>
                        <tr>
         ...
         <td><textarea rows="" cols="" name="n4"  style="width: 667px; height: 400px;" value="" ><?php if(!empty($n1)){echo $n1;}?>
         </textarea></td>
         ...
         <td><textarea rows="" cols="" name="n5"  style="width: 667px; height: 400px;" value="" ><?php if(!empty($n1)){echo $n1;}?>
         </textarea></td>
         ...
         <td><textarea rows="" cols="" name="n6"  style="width: 667px; height: 400px;" value="" ><?php if(!empty($n1)){echo $n1;}?>
         </textarea></td>
                      ...
                      <thead>
                        <tr>
                          ...
                          <th width="157">POTENSI PELAKSANAAN&#13;</th>
                        </tr>
                      </thead>
                      <tbody>
                        <tr>
         ...
         <td><textarea rows="" cols="" name="n7"  style="width: 667px; height: 400px;" value="" ><?php if(!empty($n1)){echo $n1;}?>
         </textarea></td>
                      ...
                      <thead>
                        <tr>
                          ...
                          <th width="157">KOMITMEN PENGURUSAN  ATASAN&#13;</th>
                        </tr>
                      </thead>
                      <tbody>
                        <tr>
         ...
         <td><textarea rows="" cols="" name="n14"  style="width: 667px; height: 400px;" value="" ><?php if(!empty($n1)){echo $n1;}?>
         </textarea></td>
                      ...
                      <thead>
                        <tr>
                          ...
                          <th width="157">HARTA INTELEK DAN KOMERSIAL&#13;</th>
                        </tr>
                      </thead>
                      <tbody>
                        <tr>
         ...
         <td><textarea rows="" cols="" name="n15"  style="width: 667px; height: 400px;" value="" ><?php if(!empty($n1)){echo $n1;}?>
         </textarea></td>
                      ...
                      <thead>
                        <tr>
                          ...
                          <th width="157">SENTUHAN KEPADA RAKYAT&#13;</th>
                        </tr>
                      </thead>
                      <tbody>
                        <tr>
         ...
         <td><textarea rows="" cols="" name="n8"  style="width: 667px; height: 400px;" value="" ><?php if(!empty($n1)){echo $n1;}?>
         </textarea></td>
