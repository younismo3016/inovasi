	...
	function add_ketua_organisasi()
	{
		...
		if ($check){
			...
			$data = array(			
						...
						'level' => '1',
						'id_ketua_organisasi' => $this->session->userdata('sess_id'),
						'kata_laluan' => 'f91e15dbec69fc40f81f0876e7009648',
						'date_range' => $today,						
			...
			$config = Array(
						...
						$message = '
										...
										<p>Tuan/puan,</p>
										<p><strong>Makluman Pendaftaran Sebagai Pegawai Pengesah Projek di Sistem Hab Inovasi KDN</strong></p>
										<p><br>
										Dengan segala hormatnya</p>
										<p><strong>2.</strong> Untuk makluman, pihak tuan/puan telah didaftarkan dalam Sistem Hab Inovasi KDN sebagai Pegawai Pengesah Projek.</p>
										<p><strong>3.</strong> Sehubungan itu, mohon tuan/puan untuk log masuk ke sistem menggunakan maklumat berikut:</p>
										
										<p>	 <strong>	Pautan Sistem</strong> :  http://inovasi.moha.gov.my </p>
										<p>	 <strong>	ID Pengguna</strong>        : '.$email.' . </p>
										<p>	 <strong>	Katalaluan Sementara </strong>          : Pass@123 </p>
										
										<p><strong>4.</strong> Tuan/puan dinasihatkan untuk menukar katalaluan selepas log masuk bagi tujuan keselamatan.</p>
										<p>&nbsp; </p>
										<p><strong>Sekian,  terima kasih.</strong></p>
										
										<p><em>*E-mel ini adalah janaan komputer dan tidak perlu dibalas</em></p>
										<p>&nbsp;</p></body> ';
						...
						// $data .= "Katalaluan sementara anda ialah : Pass@123"."<br>";
