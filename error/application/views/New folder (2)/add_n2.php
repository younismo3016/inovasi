                      ...
                      <tbody>
                        <tr>
                          ...
                          <td>  <div class="mws-form-item">
                                	 <textarea rows="" id=""  cols=""  name="n1" style="width: 500px; height: 200px;"  ><?php if(!empty($n2)){echo $n2;}?></textarea>
                                </div>
                        ...
                        <?php if($level=='4'){  ?>    
                          ...
                          <td><div class="mws-form-col-3-8">
                                ...
                                <div class="mws-form-item">
                                  <input type="text" name="gred" value="<?php if(!empty($markah_n2)){echo $markah_n2;}?>">
                                </div>
                              </div>
                                <?php }else{  ?>   <?php }  ?>	
                            </td>
                    ...
                    <table class="mws-table">
                      ...
                      <tbody>
                          ...
                          <td>
                            <div id="mws-jui-dialog">
                        		<div class="mws-dialog-inner"  >
                            		<p><?php if(!empty($image1_n2)){echo $image1_n2;}?><img src="<?php echo base_url();?>assets/example/cyan_hawk.jpg" alt=""></p>
                                </div>
                            </div></td>
                        ...
                        <tr>
                          ...
                          <td><?php if(!empty($image2_n1)){echo $image2_n2;}?>
