 ...
 ?>
				...
				<div class="mws-panel grid_8">
                	<div class="mws-panel-header">
                    	<span>Maklumat Penyertaan</span>
                    </div>
                    <div class="mws-panel-body no-padding">
					
                    	<form class="mws-form" action="<?php echo base_url(); ?>index.php/main/add_tarikh_tutup_proses/" method="post" name="myForm" onSubmit="return validateForm()">
                          ...
                          <div class="mws-form-row">
                              <div class="mws-form-cols">
                                <div class="mws-form-col-4-8">
                                  <label class="mws-form-label">Tarikh tutup penyertaan<span class="required"></span></label>
                                  <div class="mws-form-item">
                                   <input type="text" class="mws-datepicker large" name="tarikh_tutup" >
