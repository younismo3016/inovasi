    ...
    <div id="mws-login-wrapper">
        <div id="mws-login">
            ...
            <div id="mws-login-form">
                <form class="mws-form" form id="mws-validate" action="<?php echo base_url(); ?>index.php/login/add_daftar_proses" method="post" name="myForm" onSubmit="return validateForm()">
                   
                    <div class="mws-form-row">
                      
                        <div class="mws-form-item">
                        	<label class="mws-form-label">Nama Penuh<span class="required">*</span></label>
                           <input type="text" name="nama_penuh" id="nama_penuh" class="required" onChange="javascript:this.value=this.value.toUpperCase();">
                        </div>
                    </div>
                    <div class="mws-form-row">
                        <div class="mws-form-item">
                        	<label class="mws-form-label">Katalaluan <span class="required">*</span></label>
                            <input type="text" name="kata_laluan" class="required">
                        </div>
                    </div>
                    <div class="mws-form-row">
                        <div class="mws-form-item">
                        	<label class="mws-form-label">Email (rasmi)<span class="required">*</span></label>
                            <input type="text" name="email"  class="mws-textinput required email error">
                        </div>
                    </div>
