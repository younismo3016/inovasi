                  ...
                  <div class="mws-panel-body no-padding">
                    ...
                    <table class="mws-table">
                      <thead>
                        ...
                        <form class="mws-form" action="<?php echo base_url(); ?>index.php/main/add_n15_proses/" method="post" name="myForm" onSubmit="return validateForm()" enctype="multipart/form-data">
                        <?php }else{ ?>
              <form class="mws-form" action="<?php echo base_url(); ?>index.php/main/edit_n15_proses/" method="post" name="myForm" onSubmit="return validateForm()" enctype="multipart/form-data">
                        <?php } ?>
                      ...
                      <tbody>
                        <tr>
                          ...
                          <td><p>HARTA INTELEK DAN KOMERSIAL </p></td>
                          <td>  <div class="mws-form-item">
                                	 <textarea rows="" id=""  cols=""  name="n15" style="width: 500px; height: 200px;"  ><?php if(!empty($n15)){echo $n15;}?></textarea>
                                </div>
                  ...
                  <form class="mws-form" action="<?php echo base_url(); ?>index.php/main/edit_markah_n15_proses/" method="post" name="myForm" onSubmit="return validateForm()" >
                           <?php }else{  ?>
                  <form class="mws-form" action="<?php echo base_url(); ?>index.php/main/add_markah_n15_proses/" method="post" name="myForm" onSubmit="return validateForm()" >       
                        ...
                        <?php if($level=='4'){  ?>    
                          ...
                          <td><div class="mws-form-col-3-8">
                                ...
                                <div class="mws-form-item">
                                  <input type="number" name="markah_n15" value="<?php if(!empty($markah_n15)){echo $markah_n15;}?>" min="0" max="10">
                                /10</div>
                              </div>  </td> 
                  ...
                  <div class="mws-panel-body no-padding">
                    <table width="307" class="mws-table">
                      ...
                      <?php if($act == "add"){ ?>
                        ...
                        <form class="mws-form" action="<?php echo base_url(); ?>index.php/main/add_n15_proses/" method="post" name="myForm" onSubmit="return validateForm()" enctype="multipart/form-data">
                        <?php }else{ ?>
              <form class="mws-form" action="<?php echo base_url(); ?>index.php/main/edit_upload_n15_proses/" method="post" name="myForm" onSubmit="return validateForm()" enctype="multipart/form-data">
                        <?php } ?>
          	 ...
          	 <a href="<?php echo base_url();?>uploads/<?php echo $image1_n15; ?>" target="_blank" class="mws-gallery-btn"><?php if(!empty($image1_n15)){echo $image1_n15;}?></a>
