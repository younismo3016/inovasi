 ...
 <!-- Start: HEADER -->
  <header>
	<table width="100%" border="0" cellspacing="0" cellpadding="0">
		<tr>
			<td width="50%" td align="center"><img src ="<?php echo base_url();?>assets/images/core/bg/esurat_banner3a.jpg" style="position:absolute; top:0px; left:0px; width:100%; max-height:100%; border:0;">		
		</tr>
	</table>
    ...
    <div id="mws-login-wrapper">
        <div id="mws-login">
            ...
            <div id="mws-login-form">
                <form class="mws-form" action="<?php echo base_url();?>index.php/main/login_proses" method="post">
