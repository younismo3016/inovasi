...
class Laporan extends MY_Controller {
	...
	function laporan_surat_peribadi()
	{
		...
		if(isset($_POST['carian'])) { 
			$data['tarikh_terima_mula']= ($this->input->post('tarikh_terima_mula')); 
			$data['tarikh_terima_hingga']= ($this->input->post('tarikh_terima_hingga')); 
			$data['id_bahagian']= $this->input->post('id_bahagian'); 
...
$tarikh_terima_mula = $this->input->post('tarikh_terima_mula');
		$tarikh_terima_hingga = $this->input->post('tarikh_terima_hingga');
...
$this->db->where('tarikh_terima BETWEEN "'. date('Y-m-d',strtotime(str_replace('/', '-', $tarikh_terima_mula))). '" and "'. date('Y-m-d',strtotime(str_replace('/', '-', $tarikh_terima_hingga))).'"');
