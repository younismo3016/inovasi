            ...
            <div class="container">
                ...
                <div class="mws-panel grid_8">
                    ...
                    <div class="mws-panel-body no-padding">
                    	<form class="mws-form" action="<?php echo base_url();?>index.php/main/laporan_markah" method="post">
                        ...
                        <table class="mws-datatable-fn mws-table">
                            <thead>
                                <tr>
                                    ...
                                    <th width="42">Jabatan</th>
                                    <th width="70">Tahun </th>
                                     <th width="70">Markah</th>
							...
							?>
                                ...
                                <tr>
                                    ...
                                    <td align="center"><?php echo get_jabatan ($row->jabatan); ?></td>
                                   <td><?php echo $row->tahun; ?></td>
                                    <td ><?php echo $row->markah_peratus;?>%</td> 
                                    <td  ><span class="badge badge-success"><?php echo get_status_projek($row->status); ?></span></td>
                                </tr>
