...
class Main extends MY_Controller {
	...
	function daftar_projek_proses()
	{
		...
		$year = date('Y');	
			...
			$this->model_pengguna->update_data('user',$id_user,$data2,'id_user');
	...
	{	
		...
		$query = $this->db->query("SELECT * FROM projek left join user on projek.id_ketua_organisasi = user.id_user where id_projek= '$id_projek'");					
...
//===========================================================================================================================	
	...
	function edit_uopload_n1_proses()
