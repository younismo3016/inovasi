                  ...
                  <div class="mws-panel-body no-padding">
                    <table class="mws-table">
                      <thead>
                        ...
                        <form class="mws-form" action="<?php echo base_url(); ?>index.php/main/add_n7_proses/" method="post" name="myForm" onSubmit="return validateForm()">
                        <?php }else{ ?>
              <form class="mws-form" action="<?php echo base_url(); ?>index.php/main/edit_n7_proses/" method="post" name="myForm" onSubmit="return validateForm()">
                        <?php } ?>
                      ...
                      <tbody>
                        <tr>
                          ...
                          <td>  <div class="mws-form-item">
                                	 <textarea rows=""  cols=""  name="n7" style="width: 500px; height: 200px;"  ><?php if(!empty($n7)){echo $n7;}?></textarea>
                                </div>
