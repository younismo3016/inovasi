                    ...
                    <div class="mws-panel-body no-padding">
                        <table class="mws-datatable-fn mws-table">
                            <thead>
                                <tr>
                                    <th width="19">Bil</th>
                                    <th width="44">Tajuk Projek</th>
                                    <th width="79">Nama   Kumpulan</th>
                                    <th width="45">Status</th>
                                    <th width="63">Tindakan</th>
							...
							?>
                                ...
                                <tr>
                                    ...
                                    <td class="actions" ><center><span class="btn-group">
                                           
                                            <a href="<?php echo base_url();?>index.php/main/laporan_inovasi/<?php echo $row->id_projek; ?>" class="btn btn-small" title="kemaskini"><i class="icon-pencil"></i></a>
