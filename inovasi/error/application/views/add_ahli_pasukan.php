    ...
    <div id="mws-wrapper">
	 ...
	 <!-- ########################################### End Panel carian ################################################ -->
            	...
            	<div class="mws-panel grid_8">
                	<div class="mws-panel-header">
                    	<span><i class="icon-table"></i>Tambah Ahli Pasukan</span>
                  </div>
                        ...
                        <table class="mws-datatable-fn mws-table">
							...
							?>
                                ...
                                <tr>
                                    ...
                                    <td><a href="<?php echo base_url();?>index.php/main/ahli_pasukan/<?php echo $row->id_projek; ?>"><?php echo $row->tajuk_projek; ?></a></td>
