...
<body>
 ...
 ?>    
   ...
   <a href="<?php echo base_url();?>index.php/main/edit_daftar_projek/<?php echo $row->id_projek; ?>" class="btn btn-small" title="kemaskini"><i class="icon-pencil"></i></a>
                   ...
                   <a href="<?php echo base_url();?>index.php/main/del_projek/<?php echo $row->id_projek; ?>" class="btn btn-small"><i class="icon-trash"></i></a>
                                        </span>
                                         <?php }else{  ?>
									...
									<?php   $status  = $row->status; ?>
									 				 			...
									 				 			<?php if( $status =='2'){  ?> 
                                   <a href="<?php echo base_url();?>index.php/main/kemaskini_semula_laporan/<?php echo $row->id_projek; ?>"> Hantar</a>
									 							<?php }else{  ?>
