...
<body>
 ...
 ?>       
              ...
              <form class="mws-form" action="<?php echo base_url(); ?>index.php/main/edit_n1_proses/" method="post" name="myForm" onSubmit="return validateForm()">
                  ...
                  <form class="mws-form" action="<?php echo base_url(); ?>index.php/main/edit_markah_n1_proses/" method="post" name="myForm" onSubmit="return validateForm()" >
                           <?php }else{  ?>
                  <form class="mws-form" action="<?php echo base_url(); ?>index.php/main/add_markah_n1_proses/" method="post" name="myForm" onSubmit="return validateForm()" >       
                        ...
                        <?php if($level=='4'){  ?>    
                          ...
                          <td><div class="mws-form-col-3-8">
                                ...
                                <div class="mws-form-item">
                                  <input type="text" name="markah_n1" value="<?php if(!empty($markah_n1)){echo $markah_n1;}?>">
                                </div>
                              </div>  </td> 
