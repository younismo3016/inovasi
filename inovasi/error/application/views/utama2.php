...
<body>
            ...
            <div class="container">
                ...
                <div class="mws-panel grid_8">
                    ...
                    <div class="mws-panel-body no-padding">
                    	<form class="mws-form" action="<?php echo base_url();?>index.php/main/utama2" method="post">
   ...
   <a href="<?php echo base_url();?>index.php/main/view_projek/<?php echo $row->id_projek; ?>" class="btn btn-small" title="papar maklumat projek"><i class="icon-search"></i></a>
      <a href="<?php echo base_url();?>index.php/main/ringkasan_projek/<?php echo $row->id_projek; ?>" class="btn btn-small" title="print laporan"><i class="icon-print"></i></a>
