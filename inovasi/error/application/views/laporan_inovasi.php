                  ...
                  <div class="mws-panel-body no-padding">
                      ...
                      <tbody>
                       <tr>
                        ...
                        <tr>
                          ...
                          <?php if($level=='4'){  ?><td><?php if(!empty($markah_n1)){echo $markah_n1;}?></td><?php }else{  ?>    <?php }  ?>
                          <td>
                           <?php if(!empty($id_projek))
                          {?>
                        ...
                        <tr>
                          <td>2.</td>
                          <td><p>KEDUDUKAN SEBELUM INOVASI&#13;</p></td>
                          <td><?php $n2 = "$n2";echo substr($n2,0,160);?>...</td>
                          <td><a href="<?php echo base_url();?>uploads/<?php echo $image1_n2; ?>" target="_blank" class="mws-gallery-btn"><?php if(!empty($image1_n2)){echo $image1_n2;}?></a>
                            <p>
                              <?php if(!empty($image2_n2)){echo $image2_n2;}?>
                          </p></td>
                           <?php if($level=='4'){  ?><td><?php if(!empty($markah_n2)){echo $markah_n2;}?></td><?php }else{  ?>    <?php }  ?>
                          <td><?php if(!empty($id_projek))
                          {?>
                            <a href="<?php echo base_url();?>index.php/main/edit_n2/<?php echo $id_projek; ?>"><img src="<?php echo base_url();?>assets/css/icons/32/magnifier_zoom_in.png" width="20" height="20" alt="kemaskini" title="kemaskini"/></a>
                            <?php } else {?>
                            <a href="<?php echo base_url();?>index.php/main/add_n2/<?php echo $key; ?>"><img src="<?php echo base_url();?>assets/css/icons/32/add.png" width="20" height="20" alt="Tambah" title="Tambah"/></a>
                            <?php } ?></td>
                        </tr>
                        <tr>
                          <td>3.</td>
                          <td><p>MASALAH YANG DIHADAPI&#13;</p></td>
                          <td><?php $n3 = "$n3";echo substr($n3,0,160);?>...</td>
                          <td><a href="<?php echo base_url();?>uploads/<?php echo $image1_n3; ?>" target="_blank" class="mws-gallery-btn"><?php if(!empty($image1_n3)){echo $image1_n3;}?></a>
                            <p>
                              <?php if(!empty($image2_n3)){echo $image2_n3;}?>
                          </p></td>
                           <?php if($level=='4'){  ?><td><?php if(!empty($markah_n3)){echo $markah_n3;}?></td><?php }else{  ?>    <?php }  ?>
                          <td><?php if(!empty($id_projek))
                          {?>
                            <a href="<?php echo base_url();?>index.php/main/edit_n3/<?php echo $id_projek; ?>"><img src="<?php echo base_url();?>assets/css/icons/32/magnifier_zoom_in.png" width="20" height="20" alt="kemaskini" title="kemaskini"/></a>
                            <?php } else {?>
                            <a href="<?php echo base_url();?>index.php/main/add_n3/<?php echo $key; ?>"><img src="<?php echo base_url();?>assets/css/icons/32/add.png" width="20" height="20" alt="Tambah" title="Tambah"/></a>
                            <?php } ?></td>
                        </tr>
                        <tr>
                          <td>4.</td>
                          <td><p>INOVASI YANG DILAKSANAKAN&#13;</p></td>
                          <td><?php $n4 = "$n4";echo substr($n4,0,160);?>...</td>
                          <td><a href="<?php echo base_url();?>uploads/<?php echo $image1_n4; ?>" target="_blank" class="mws-gallery-btn"><?php if(!empty($image1_n4)){echo $image1_n4;}?></a>
                            <p>
                              <?php if(!empty($image2_n4)){echo $image2_n4;}?>
                          </p></td>
                           <?php if($level=='4'){  ?><td><?php if(!empty($markah_n4)){echo $markah_n4;}?></td><?php }else{  ?>    <?php }  ?>
                          <td><?php if(!empty($id_projek))
                          {?>
                            <a href="<?php echo base_url();?>index.php/main/edit_n4/<?php echo $id_projek; ?>"><img src="<?php echo base_url();?>assets/css/icons/32/magnifier_zoom_in.png" width="20" height="20" alt="kemaskini" title="kemaskini"/></a>
                            <?php } else {?>
                            <a href="<?php echo base_url();?>index.php/main/add_n4/<?php echo $key; ?>"><img src="<?php echo base_url();?>assets/css/icons/32/add.png" width="20" height="20" alt="Tambah" title="Tambah"/></a>
                            <?php } ?></td>
                        </tr>
                        <tr>
                          <td>5</td>
                          ...
                          <td><a href="<?php echo base_url();?>uploads/<?php echo $image1_n5; ?>" target="_blank" class="mws-gallery-btn"><?php if(!empty($image1_n5)){echo $image1_n5;}?></a>
                           ...
                           <td><?php echo $markah_n5;?>/25</td><?php }else{  ?>    <?php }  ?>
                          <td><?php if(!empty($id_projek))
                          {?>
                        ...
                        <tr>
                          <td>6.</td>
                          <td><p>EFISIENSI – PENJIMATAN MASA&#13;</p></td>
                          <td><?php $n6 = "$n6";echo substr($n6,0,160);?>...</td>
                          <td><a href="<?php echo base_url();?>uploads/<?php echo $image1_6; ?>" target="_blank" class="mws-gallery-btn"><?php if(!empty($image1_n6)){echo $image1_n6;}?></a>
                            <p>
                              <?php if(!empty($image2_n6)){echo $image2_n6;}?>
                          </p></td>
                           <?php if($level=='4'){  ?>
                           <td><?php echo $markah_n6;?>/10</td><?php }else{  ?>    <?php }  ?>
                          <td><?php if(!empty($id_projek))
                          {?>
                        ...
                        <tr>
                          <td>6.3</td>
                          <td><p>EFISIENSI – PENINGKATAN PRODUKTIVITI&#13;</p></td>
                          ...
                          <?php if($level=='4'){  ?>
                          <td><?php echo $markah_n8;?>/5</td><?php }else{  ?>    <?php }  ?>
                          <td><?php if(!empty($id_projek))
                          {?>
                        ...
                        <tr>
                          <td>6.4</td>
                          <td><p>EFISIENSI –MUDAH DIGUNAKAN (USER FRIENDLY)&#13;</p></td>
                          ...
                          <?php if($level=='4'){  ?>
                          <td><?php echo $markah_n9;?>/5</td><?php }else{  ?>    <?php }  ?>
                          <td><?php if(!empty($id_projek))
                          {?>
                         ...
                         <tr>
                          <td>6.5.</td>
                          <td><p>EFISIENSI – LAIN-LAIN FAEDAH&#13;</p></td>
                          <td><?php $n10 = "$n10";echo substr($n10,0,160);?>...</td>
                          <td><a href="<?php echo base_url();?>uploads/<?php echo $image1_n10; ?>" target="_blank" class="mws-gallery-btn"><?php if(!empty($image1_n10)){echo $image1_n10;}?></a>
                            <p>
                              <?php if(!empty($image2_n10)){echo $image2_n10;}?>
                           </p></td>
                           <?php if($level=='4'){  ?><td><?php if(!empty($markah_n10)){echo $markah_n10;}?></td><?php }else{  ?>    <?php }  ?>
                          <td><?php if(!empty($id_projek))
                          {?>
                            <a href="<?php echo base_url();?>index.php/main/edit_n10/<?php echo $id_projek; ?>"><img src="<?php echo base_url();?>assets/css/icons/32/magnifier_zoom_in.png" width="20" height="20" alt="kemaskini" title="kemaskini"/></a>
                            <?php } else {?>
                            <a href="<?php echo base_url();?>index.php/main/add_n10/<?php echo $key; ?>"><img src="<?php echo base_url();?>assets/css/icons/32/add.png" width="20" height="20" alt="Tambah" title="Tambah"/></a>
                            <?php } ?></td>
                        </tr>
                        <tr>
                          <td>7.</td>
                         ...
                         <tr>
                          <td>10.</td>
                          <td><p>KOMITMEN PENGURUSAN  ATASAN&#13;</p></td>
                          <td><?php $n14 = "$n14";echo substr($n14,0,160);?>...</td>
                          <td><a href="<?php echo base_url();?>uploads/<?php echo $image1_n14; ?>" target="_blank" class="mws-gallery-btn"><?php if(!empty($image1_n14)){echo $image1_n14;}?></a>
                            <p>
                              <?php if(!empty($image2_n14)){echo $image2_n14;}?>
                           </p></td>
                           <?php if($level=='4'){  ?>
                           <td><?php echo $markah_n14;?>/5</td><?php }else{  ?>    <?php }  ?>
                          <td><?php if(!empty($id_projek))
                          {?>
                            <a href="<?php echo base_url();?>index.php/main/edit_n14/<?php echo $id_projek; ?>"><img src="<?php echo base_url();?>assets/css/icons/32/magnifier_zoom_in.png" width="20" height="20" alt="kemaskini" title="kemaskini"/></a>
                            <?php } else {?>
                            <a href="<?php echo base_url();?>index.php/main/add_n14/<?php echo $key; ?>"><img src="<?php echo base_url();?>assets/css/icons/32/add.png" width="20" height="20" alt="Tambah" title="Tambah"/></a>
                            <?php } ?></td>
                        </tr>
                         <tr>
                          <td>11.</td>
                          <td><p>HARTA INTELEK DAN KOMERSIAL&#13;</p></td>
                          <td><?php $n15 = "$n15";echo substr($n15,0,160);?>...</td>
                          <td><a href="<?php echo base_url();?>uploads/<?php echo $image1_n15; ?>" target="_blank" class="mws-gallery-btn"><?php if(!empty($image1_n15)){echo $image1_n15;}?></a>
                            <p>
                              <?php if(!empty($image2_n15)){echo $image2_n15;}?>
                           </p></td>
                           <?php if($level=='4'){  ?>
                           <td><?php echo $markah_n15;?>/10</td><?php }else{  ?>    <?php }  ?>
                          <td><?php if(!empty($id_projek))
                          {?>
                            <a href="<?php echo base_url();?>index.php/main/edit_n15/<?php echo $id_projek; ?>"><img src="<?php echo base_url();?>assets/css/icons/32/magnifier_zoom_in.png" width="20" height="20" alt="kemaskini" title="kemaskini"/></a>
                            <?php } else {?>
                            <a href="<?php echo base_url();?>index.php/main/add_n15/<?php echo $key; ?>"><img src="<?php echo base_url();?>assets/css/icons/32/add.png" width="20" height="20" alt="Tambah" title="Tambah"/></a>
                            <?php } ?></td>
                        </tr>
                         <tr>
                          <td>12.</td>
                          <td><p>SENTUHAN KEPADA RAKYAT&#13;</p></td>
                          <td><?php $n16 = "$n16";echo substr($n16,0,160);?>...</td>
                          <td><a href="<?php echo base_url();?>uploads/<?php echo $image1_n16; ?>" target="_blank" class="mws-gallery-btn"><?php if(!empty($image1_n16)){echo $image1_n16;}?></a>
                            <p>
                              <?php if(!empty($image2_n16)){echo $image2_n16;}?>
                           </p></td>
                           <?php if($level=='4'){  ?>
                           <td><?php echo $markah_n16;?>/10</td><?php }else{  ?>    <?php }  ?>
                          <td><?php if(!empty($id_projek))
                          {?>
                            <a href="<?php echo base_url();?>index.php/main/edit_n16/<?php echo $id_projek; ?>"><img src="<?php echo base_url();?>assets/css/icons/32/magnifier_zoom_in.png" width="20" height="20" alt="kemaskini" title="kemaskini"/></a>
                            <?php } else {?>
                            <a href="<?php echo base_url();?>index.php/main/add_n16/<?php echo $key; ?>"><img src="<?php echo base_url();?>assets/css/icons/32/add.png" width="20" height="20" alt="Tambah" title="Tambah"/></a>
                            <?php } ?></td>
                          </tr>
                          <?php if($level=='4') {?>
                          <tr>
                          ...
                          <td><p>&nbsp;</p></td>
                           <?php if($level=='4'){  ?>
                           <td> <?php $total= $markah_n5 + $markah_n6 + $markah_n7 + $markah_n8 + $markah_n9 + $markah_n11 + $markah_n12 + $markah_n13 + $markah_n14 + $markah_n15 + $markah_n16;   
						   
						   $peratus = $total/120 *100; 
                    ...
                    <!--     <?php// if(!empty($markah_n5) && !empty($markah_n6) && !empty($markah_n7) && !empty($markah_n8) && !empty($markah_n9) && !empty($markah_n11) && !empty($markah_n12) && !empty($markah_n13) && !empty($markah_n14) && !empty($markah_n15) && !empty($markah_n16)){?>
                       ...
                       <?php// }?> -->
                            ...
                            <?php if(($markah_n5 >= '0') && ($markah_n6 >= '0') && ($markah_n7 >= '0') && ($markah_n8 >= '0') && ($markah_n9 >= '0') && ($markah_n11 >= '0') && ($markah_n12 >= '0') && ($markah_n13 >= '0') && ($markah_n14 >= '0') && ($markah_n15 >= '0') && ($markah_n16 >= '0')){?>
                         <button type="submit" class="btn btn-primary" id="validateButton" name="validateButton">Simpan Markah</button>
                       <?php  }?>                    
                         ...
                         <?php if((!empty($n1) && !empty($n2))  && !empty($n3) && !empty($n4) && !empty($n5) && !empty($n6) && !empty($n7) && !empty($n8) && !empty($n9) && !empty($n10) && !empty($n11) && !empty($n12) && !empty($n13) && !empty($n14) && !empty($n15) && !empty($n16)&& ($status =="1")){?>
